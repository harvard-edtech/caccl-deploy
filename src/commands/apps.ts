    ...
    for (const app of apps) {
      if (app !== undefined) {
        if (fullStatus === false) {
          ...
          appData.push(app, deployConfig.infraStackName);
