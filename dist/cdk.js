...
var CacclDbEngine = /* @__PURE__ */ ((CacclDbEngine2) => {
  CacclDbEngine2['DocDB'] = 'docdb';
  CacclDbEngine2['MySQL'] = 'mysql';
  return CacclDbEngine2;
})(CacclDbEngine || {});
...
// cdk/lib/classes/CacclDbBase.ts
var CacclDbBase = class extends import_constructs.Construct {
  ...
  constructor(scope, id, props) {
    ...
    this.removalPolicy = import_aws_cdk_lib.RemovalPolicy[removalPolicy];
    this.etcRemovalPolicy =
      this.removalPolicy === import_aws_cdk_lib.RemovalPolicy.RETAIN
        ? import_aws_cdk_lib.RemovalPolicy.RETAIN
        : import_aws_cdk_lib.RemovalPolicy.DESTROY;
    this.dbPasswordSecret = new import_aws_cdk_lib.aws_secretsmanager.Secret(
      this,
      'DbPasswordSecret',
      {
        description: `docdb master user password for ${
          import_aws_cdk_lib.Stack.of(this).stackName
        }`,
    ...
    this.dbSg = new import_aws_cdk_lib.aws_ec2.SecurityGroup(
      this,
      'DbSecurityGroup',
      {
        vpc,
    ...
    this.dbSg.addEgressRule(
      import_aws_cdk_lib.aws_ec2.Peer.anyIpv4(),
      import_aws_cdk_lib.aws_ec2.Port.allTcp(),
    );
  }
  // FIXME: doesn't do anything?
  createOutputs() {
    new import_aws_cdk_lib.CfnOutput(this, 'DbClusterEndpoint', {
      exportName: `${
        import_aws_cdk_lib.Stack.of(this).stackName
      }-db-cluster-endpoint`,
      value: `${this.host}:${this.port}`,
    });
    new import_aws_cdk_lib.CfnOutput(this, 'DbSecretArn', {
      exportName: `${
        import_aws_cdk_lib.Stack.of(this).stackName
  ...
  addSecurityGroupIngress(vpcCidrBlock) {
    ...
    this.dbCluster.connections.allowDefaultPortFrom(
      import_aws_cdk_lib.aws_ec2.Peer.ipv4(vpcCidrBlock),
    );
  }
};
...
var CacclDocDb = class extends CacclDbBase_default {
  constructor(scope, id, props) {
    ...
    const parameterGroup =
      new import_aws_cdk_lib2.aws_docdb.ClusterParameterGroup(
        this,
    ...
    this.dbCluster = new import_aws_cdk_lib2.aws_docdb.DatabaseCluster(
      this,
      'DocDbCluster',
      {
        masterUser: {
          username: 'root',
          password: import_aws_cdk_lib2.SecretValue.secretsManager(
        ...
        vpc,
        instanceType: new import_aws_cdk_lib2.aws_ec2.InstanceType(
          instanceType,
        ),
        vpcSubnets: {
          subnetType:
            import_aws_cdk_lib2.aws_ec2.SubnetType.PRIVATE_WITH_EGRESS,
        },
        securityGroup: this.dbSg,
        backup: {
          retention: import_aws_cdk_lib2.Duration.days(14),
        },
    ...
    appEnv.addSecret(
      'MONGO_PASS',
      import_aws_cdk_lib2.aws_ecs.Secret.fromSecretsManager(
  ...
  makeDocDbMetric(metricName, extraProps = {}) {
    const metric = new import_aws_cdk_lib2.aws_cloudwatch.Metric(
      __spreadValues(
        {
          metricName,
    ...
    ).with({ period: import_aws_cdk_lib2.Duration.minutes(1) });
  ...
  createMetricsAndAlarms() {
    this.metrics = {
      ...
      CPUUtilization: [
        this.makeDocDbMetric('CPUUtilization', {
          unit: import_aws_cdk_lib2.aws_cloudwatch.Unit.PERCENT,
        }),
      ],
      ...
      ReadLatency: [
        this.makeDocDbMetric('ReadLatency', {
          unit: import_aws_cdk_lib2.aws_cloudwatch.Unit.MILLISECONDS,
        }),
      ],
      WriteLatency: [
    ...
    this.alarms = [
      new import_aws_cdk_lib2.aws_cloudwatch.Alarm(
        this,
        'CPUUtilizationAlarm',
        {
          metric: this.metrics.CPUUtilization[0].with({
            period: import_aws_cdk_lib2.Duration.minutes(5),
          }),
          threshold: 50,
          evaluationPeriods: 3,
          alarmDescription: `${
      ...
      new import_aws_cdk_lib2.aws_cloudwatch.Alarm(
        ...
        'BufferCacheHitRatioAlarm',
        {
          ...
          evaluationPeriods: 3,
          comparisonOperator:
            import_aws_cdk_lib2.aws_cloudwatch.ComparisonOperator
      ...
      new import_aws_cdk_lib2.aws_cloudwatch.Alarm(this, 'DiskQueueDepth', {
      ...
      new import_aws_cdk_lib2.aws_cloudwatch.Alarm(this, 'ReadLatency', {
        metric: this.metrics.ReadLatency[0],
        threshold: 20,
        evaluationPeriods: 3,
        treatMissingData:
          import_aws_cdk_lib2.aws_cloudwatch.TreatMissingData.IGNORE,
        alarmDescription: `${
          import_aws_cdk_lib2.Stack.of(this).stackName
        } docdb read latency alarm`,
      }),
      new import_aws_cdk_lib2.aws_cloudwatch.Alarm(this, 'WriteLatency', {
  ...
  getDashboardLink() {
    const { region } = import_aws_cdk_lib2.Stack.of(this);
...
var CacclRdsDb = class extends CacclDbBase_default {
  constructor(scope, id, props) {
    ...
    const auroraMysqlEngineVersion =
      import_aws_cdk_lib3.aws_rds.DatabaseClusterEngine.auroraMysql({
        version: import_aws_cdk_lib3.aws_rds.AuroraMysqlEngineVersion.of(
          engineVersion,
          majorVersion,
        ),
      });
    ...
    this.dbCluster = new import_aws_cdk_lib3.aws_rds.DatabaseCluster(
      this,
      'RdsDbCluster',
      {
        engine: auroraMysqlEngineVersion,
        ...
        credentials: {
          username: 'root',
          password: import_aws_cdk_lib3.SecretValue.secretsManager(
            this.dbPasswordSecret.secretArn,
          ),
        },
        ...
        instanceProps: {
          vpc,
          instanceType: new import_aws_cdk_lib3.aws_ec2.InstanceType(
            instanceType,
          ),
          ...
          vpcSubnets: {
            subnetType:
              import_aws_cdk_lib3.aws_ec2.SubnetType.PRIVATE_WITH_EGRESS,
          },
          securityGroups: [this.dbSg],
        },
        backup: {
          retention: import_aws_cdk_lib3.Duration.days(14),
        },
        removalPolicy: this.removalPolicy,
      },
    );
    ...
    appEnv.addSecret(
      'DATABASE_PASSWORD',
      import_aws_cdk_lib3.aws_ecs.Secret.fromSecretsManager(
        this.dbPasswordSecret,
      ),
    );
    this.createMetricsAndAlarms();
  ...
  makeInstanceMetrics(metricName, extraProps = {}) {
    return this.dbCluster.instanceIdentifiers.map((id) => {
      const metric = new import_aws_cdk_lib3.aws_cloudwatch.Metric(
        __spreadValues(
          {
            metricName,
            namespace: this.metricNamespace,
  ...
  createMetricsAndAlarms() {
    this.metrics = {
      ...
      CPUUtilization: this.makeInstanceMetrics('CPUUtilization', {
        unit: import_aws_cdk_lib3.aws_cloudwatch.Unit.PERCENT,
      }),
    ...
    this.alarms = [
      ...this.metrics.ReadIOPS.map((metric, idx) => {
        return new import_aws_cdk_lib3.aws_cloudwatch.Alarm(
          this,
      ...
      ...this.metrics.BufferCacheHitRatio.map((metric, idx) => {
        return new import_aws_cdk_lib3.aws_cloudwatch.Alarm(
          ...
          `BufferCacheHitRatioAlarm-${idx}`,
          {
            ...
            evaluationPeriods: 3,
            comparisonOperator:
              import_aws_cdk_lib3.aws_cloudwatch.ComparisonOperator
                .LESS_THAN_OR_EQUAL_TO_THRESHOLD,
            alarmDescription: `${
              import_aws_cdk_lib3.Stack.of(this).stackName
  ...
  getDashboardLink() {
    const { region } = import_aws_cdk_lib3.Stack.of(this);
    const dbClusterId = this.dbCluster.clusterIdentifier;
...
var CacclAppEnvironment = class extends import_constructs2.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    this.env = {
      PORT: '8080',
    ...
    Object.entries(props.envVars).forEach(([name, value]) => {
      if (value.toString().toLowerCase().startsWith('arn:aws:secretsmanager')) {
        const varSecret =
          import_aws_cdk_lib4.aws_secretsmanager.Secret.fromSecretCompleteArn(
            this,
            `${name}SecretArn`,
            value,
          );
        this.secrets[name] =
          import_aws_cdk_lib4.aws_ecs.Secret.fromSecretsManager(varSecret);
      } else {
        this.env[name] = value;
      }
    });
...
var CacclCache = class extends import_constructs3.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const { vpc, appEnv } = props;
    const {
    ...
    const subnetGroup = new import_aws_cdk_lib5.aws_elasticache.CfnSubnetGroup(
      this,
      'CacheSubnetGroup',
      {
    ...
    this.cacheSg = new import_aws_cdk_lib5.aws_ec2.SecurityGroup(
      this,
      'CacheSecurityGroup',
      {
        vpc,
    ...
    this.cacheSg.addIngressRule(
      import_aws_cdk_lib5.aws_ec2.Peer.ipv4(vpc.vpcCidrBlock),
      import_aws_cdk_lib5.aws_ec2.Port.tcp(6379),
      'allow from internal network',
    );
    this.cacheSg.addEgressRule(
      import_aws_cdk_lib5.aws_ec2.Peer.anyIpv4(),
      import_aws_cdk_lib5.aws_ec2.Port.allTcp(),
    );
    this.cache = new import_aws_cdk_lib5.aws_elasticache.CfnCacheCluster(
      this,
      'CacheCluster',
      {
        engine,
    ...
    new import_aws_cdk_lib5.CfnOutput(this, 'CacheClusterEndpoint', {
      exportName: `${
        import_aws_cdk_lib5.Stack.of(this).stackName
      }-cache-endpoint`,
...
var CacclLoadBalancer = class extends import_constructs4.Construct {
  constructor(scope, id, props) {
    var _a2, _b2;
    super(scope, id);
    const {
    ...
    const healthCheckPath =
      ...
      null
        ...
        : '/';
    this.loadBalancer =
      new import_aws_cdk_lib6.aws_elasticloadbalancingv2.ApplicationLoadBalancer(
        this,
        'LoadBalancer',
        {
          vpc,
    ...
    if (albLogBucketName2 !== void 0) {
      const bucket = import_aws_cdk_lib6.aws_s3.Bucket.fromBucketName(
        this,
        'AlbLogBucket',
        albLogBucketName2,
      );
      const objPrefix = import_aws_cdk_lib6.Stack.of(this).stackName;
      this.loadBalancer.logAccessLogs(bucket, objPrefix);
    }
    new import_aws_cdk_lib6.aws_elasticloadbalancingv2.CfnListener(
      this,
      'HttpRedirect',
      {
        loadBalancerArn: this.loadBalancer.loadBalancerArn,
        protocol:
          import_aws_cdk_lib6.aws_elasticloadbalancingv2.ApplicationProtocol
            .HTTP,
        port: 80,
        defaultActions: [
          {
    ...
    const httpsListener =
      new import_aws_cdk_lib6.aws_elasticloadbalancingv2.ApplicationListener(
        this,
        'HttpsListener',
        {
    ...
    const atgProps = {
      ...
      stickinessCookieDuration: import_aws_cdk_lib6.Duration.seconds(86400),
      targetType: import_aws_cdk_lib6.aws_elasticloadbalancingv2.TargetType.IP,
      targets: [loadBalancerTarget],
      deregistrationDelay: import_aws_cdk_lib6.Duration.seconds(
    ...
    const appTargetGroup =
      new import_aws_cdk_lib6.aws_elasticloadbalancingv2.ApplicationTargetGroup(
        this,
        'TargetGroup',
        atgProps,
      );
    ...
    this.metrics = {
      ...
      TargetResponseTime: this.loadBalancer
        .metricTargetResponseTime({
          period: import_aws_cdk_lib6.Duration.minutes(1),
          unit: import_aws_cdk_lib6.aws_cloudwatch.Unit.MILLISECONDS,
          statistic: 'avg',
        })
        .with({ period: import_aws_cdk_lib6.Duration.minutes(1) }),
    ...
    this.alarms = [
      new import_aws_cdk_lib6.aws_cloudwatch.Alarm(
        this,
        'TargetResponseTimeAlarm',
        {
          ...
          evaluationPeriods: 3,
          treatMissingData:
            import_aws_cdk_lib6.aws_cloudwatch.TreatMissingData.IGNORE,
          alarmDescription: `${
            import_aws_cdk_lib6.Stack.of(this).stackName
      ...
      new import_aws_cdk_lib6.aws_cloudwatch.Alarm(this, 'UnhealthHostAlarm', {
    ...
    new import_aws_cdk_lib6.CfnOutput(this, 'LoadBalancerHostname', {
      exportName: `${
        import_aws_cdk_lib6.Stack.of(this).stackName
    ...
    if (securityGroups.primary) {
      new import_aws_cdk_lib6.CfnOutput(
        this,
    ...
    if (securityGroups.misc) {
      new import_aws_cdk_lib6.CfnOutput(this, 'LoadBalancerMiscSecurityGroup', {
        exportName: `${
          import_aws_cdk_lib6.Stack.of(this).stackName
        }-misc-security-group`,
...
var CacclMonitoring = class extends import_constructs5.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const { stackName: stackName2 } = import_aws_cdk_lib7.Stack.of(this);
    ...
    this.dashboard = new import_aws_cdk_lib7.aws_cloudwatch.Dashboard(
      this,
      'Dashboard',
      {
        dashboardName,
    ...
    this.dashboard.addWidgets(
      new import_aws_cdk_lib7.aws_cloudwatch.TextWidget({
        markdown: [
    ...
    this.dashboard.addWidgets(
      new import_aws_cdk_lib7.aws_cloudwatch.GraphWidget({
        title: 'RequestCount',
    ...
    this.dashboard.addWidgets(
      new import_aws_cdk_lib7.aws_cloudwatch.AlarmStatusWidget({
    ...
    const httpCodeWidgets = ['2', '3', '4', '5'].map((i) => {
      ...
      return new import_aws_cdk_lib7.aws_cloudwatch.GraphWidget({
        title: metricName,
        left: [
          loadBalancer.metricHttpCodeTarget(
            import_aws_cdk_lib7.aws_elasticloadbalancingv2.HttpCodeTarget[
              httpCode
            ],
          ),
        ],
    ...
    const makeCIMetric = (metricName, extraProps = {}) => {
      const metric = new import_aws_cdk_lib7.aws_cloudwatch.Metric(
        __spreadValues(
          {
            metricName,
      ...
      new import_aws_cdk_lib7.aws_cloudwatch.GraphWidget({
        ...
        left: [
          makeCIMetric('CpuUtilized', {
            unit: import_aws_cdk_lib7.aws_cloudwatch.Unit.PERCENT,
          }),
...
var CacclNotifications = class extends import_constructs6.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const email = typeof props.email === 'string' ? [props.email] : props.email;
    const { slack, service, loadBalancer, db } = props;
    this.topic = new import_aws_cdk_lib8.aws_sns.Topic(
      this,
      'NotificationTopic',
      {
        displayName: `${
    ...
    this.topic.grantPublish({
      grantPrincipal: new import_aws_cdk_lib8.aws_iam.ServicePrincipal(
        'cloudwatch.amazonaws.com',
      ),
    });
    if (email) {
      email.forEach((emailAddr, idx) => {
        new import_aws_cdk_lib8.aws_sns.Subscription(
          this,
          `email-subscription-${idx}`,
          {
            topic: this.topic,
            protocol: import_aws_cdk_lib8.aws_sns.SubscriptionProtocol.EMAIL,
            endpoint: emailAddr,
          },
        );
      });
    ...
    if (slack !== void 0) {
      const slackFunction = new import_aws_cdk_lib8.aws_lambda.Function(
        this,
        'SlackFunction',
        {
          functionName: `${
          ...
          runtime: import_aws_cdk_lib8.aws_lambda.Runtime.PYTHON_3_8,
          handler: 'notify.handler',
          code: import_aws_cdk_lib8.aws_lambda.Code.fromAsset(
      ...
      this.topic.addSubscription(
        new import_aws_cdk_lib8.aws_sns_subscriptions.LambdaSubscription(
          slackFunction,
        ),
      );
    }
    loadBalancer.alarms.forEach((alarm) => {
      alarm.addAlarmAction(
        new import_aws_cdk_lib8.aws_cloudwatch_actions.SnsAction(this.topic),
      );
    });
    ...
    db == null
      ...
      : db.alarms.forEach((alarm) => {
          alarm.addAlarmAction(
            new import_aws_cdk_lib8.aws_cloudwatch_actions.SnsAction(
              this.topic,
            ),
          );
        });
    new import_aws_cdk_lib8.CfnOutput(this, 'TopicName', {
      exportName: `${
        import_aws_cdk_lib8.Stack.of(this).stackName
      }-sns-topic-name`,
      value: this.topic.topicName,
    });
    new import_aws_cdk_lib8.CfnOutput(this, 'TopicArn', {
      exportName: `${
        import_aws_cdk_lib8.Stack.of(this).stackName
      }-sns-topic-arn`,
...
var CacclScheduledTasks = class extends import_constructs7.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    this.eventRules = [];
    this.alarms = [];
    const {
      ...
      region,
      account,
    } = import_aws_cdk_lib9.Stack.of(this);
    const { clusterName, serviceName, taskDefinition, vpc, scheduledTasks } =
      props;
    this.taskExecFunction = new import_aws_cdk_lib9.aws_lambda.Function(
      this,
      'ScheduledTaskExecFunction',
      {
        functionName: `${stackName2}-scheduled-task-exec`,
        runtime: import_aws_cdk_lib9.aws_lambda.Runtime.NODEJS_12_X,
        handler: 'index.handler',
        code: import_aws_cdk_lib9.aws_lambda.Code.fromAsset(
          import_path2.default.join(__dirname, 'assets/scheduled_task_exec'),
        ),
        vpc,
        vpcSubnets: {
          subnetType:
            import_aws_cdk_lib9.aws_ec2.SubnetType.PRIVATE_WITH_EGRESS,
        },
        environment: {
    ...
    Object.keys(scheduledTasks).forEach((scheduledTaskId) => {
      ...
      const eventTarget =
        new import_aws_cdk_lib9.aws_events_targets.LambdaFunction(
          this.taskExecFunction,
          {
            // this is the json event object that the lambda function receives
            event: import_aws_cdk_lib9.aws_events.RuleTargetInput.fromObject({
      ...
      const ruleName = `${import_aws_cdk_lib9.Stack.of(
        this,
      )}-scheduled-task-${scheduledTaskId}`;
      const eventRule = new import_aws_cdk_lib9.aws_events.Rule(
        this,
    ...
    this.taskExecFunction.addToRolePolicy(
      new import_aws_cdk_lib9.aws_iam.PolicyStatement({
        effect: import_aws_cdk_lib9.aws_iam.Effect.ALLOW,
    ...
    this.alarms = [
      ...
      new import_aws_cdk_lib9.aws_cloudwatch.Alarm(this, 'ErrorAlarm', {
        metric: this.taskExecFunction
          .metricErrors()
          .with({ period: import_aws_cdk_lib9.Duration.minutes(5) }),
        threshold: 1,
        evaluationPeriods: 1,
        alarmDescription: `${stackName2} scheduled task execution error alarm`,
      }),
      // alarm if function isn't invoked at least once per day
      new import_aws_cdk_lib9.aws_cloudwatch.Alarm(this, 'InvocationsAlarm', {
        metric: this.taskExecFunction
          .metricInvocations()
          .with({ period: import_aws_cdk_lib9.Duration.days(1) }),
        threshold: 1,
        evaluationPeriods: 1,
        alarmDescription: `${stackName2} no invocations alarm`,
        comparisonOperator:
          import_aws_cdk_lib9.aws_cloudwatch.ComparisonOperator
            .LESS_THAN_THRESHOLD,
      }),
    ];
    new import_aws_cdk_lib9.CfnOutput(this, 'DeployConfigHash', {
...
var CacclService = class extends import_constructs8.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const {
      cluster,
    ...
    const serviceSg = new import_aws_cdk_lib10.aws_ec2.SecurityGroup(
      this,
      'SecurityGroup',
      {
        vpc: cluster.vpc,
    ...
    serviceSg.connections.allowFrom(
      loadBalancerSg,
      import_aws_cdk_lib10.aws_ec2.Port.tcp(443),
    );
    this.ecsService = new import_aws_cdk_lib10.aws_ecs.FargateService(
      this,
      'FargateService',
      {
        cluster,
        ...
        platformVersion:
          import_aws_cdk_lib10.aws_ecs.FargatePlatformVersion.VERSION1_4,
        ...
        propagateTags: import_aws_cdk_lib10.aws_ecs.PropagatedTagSource.SERVICE,
    ...
    this.alarms = [];
    new import_aws_cdk_lib10.CfnOutput(this, 'ClusterName', {
      exportName: `${
        import_aws_cdk_lib10.Stack.of(this).stackName
      }-cluster-name`,
      value: cluster.clusterName,
    });
    new import_aws_cdk_lib10.CfnOutput(this, 'ServiceName', {
      exportName: `${
        import_aws_cdk_lib10.Stack.of(this).stackName
      }-service-name`,
...
// cdk/lib/classes/CacclSshBastion.ts
var CacclSshBastion = class extends import_constructs9.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const { vpc, sg } = props;
    this.instance = new import_aws_cdk_lib11.aws_ec2.BastionHostLinux(
      this,
      'SshBastionHost',
      {
        vpc,
        subnetSelection: {
          subnetType: import_aws_cdk_lib11.aws_ec2.SubnetType.PUBLIC,
        },
        instanceName: `${
          import_aws_cdk_lib11.Stack.of(this).stackName
        }-bastion`,
        securityGroup: sg,
        machineImage: import_aws_cdk_lib11.aws_ec2.MachineImage.genericLinux(
          DEFAULT_AMI_MAP_default,
        ),
      },
    );
    new import_aws_cdk_lib11.CfnOutput(this, 'DbBastionHostIp', {
      exportName: `${
        import_aws_cdk_lib11.Stack.of(this).stackName
      }-bastion-host-ip`,
      value: this.instance.instancePublicIp,
    });
    new import_aws_cdk_lib11.CfnOutput(this, 'DbBastionHostId', {
      exportName: `${
        import_aws_cdk_lib11.Stack.of(this).stackName
      }-bastion-host-id`,
      value: this.instance.instanceId,
    });
    new import_aws_cdk_lib11.CfnOutput(this, 'DbBastionHostAZ', {
      exportName: `${
        import_aws_cdk_lib11.Stack.of(this).stackName
      }-bastion-host-az`,
      value: this.instance.instanceAvailabilityZone,
    });
    new import_aws_cdk_lib11.CfnOutput(this, 'DbBastionSecurityGroupId', {
      exportName: `${
        import_aws_cdk_lib11.Stack.of(this).stackName
...
var CacclContainerImage = class extends import_constructs10.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    ...
    if (appImage !== void 0) {
      if (appImage.startsWith('arn:aws:ecr')) {
        ...
        const repo = import_aws_cdk_lib12.aws_ecr.Repository.fromRepositoryArn(
          this,
          'ContainerImageRepo',
          repoArn,
        );
        this.image =
          import_aws_cdk_lib12.aws_ecs.ContainerImage.fromEcrRepository(
            repo,
            repoTag,
          );
      } else {
        this.image =
          import_aws_cdk_lib12.aws_ecs.ContainerImage.fromRegistry(appImage);
      }
      ...
      this.image =
        import_aws_cdk_lib12.aws_ecs.ContainerImage.fromAsset(buildPath);
    } else {
...
// cdk/lib/classes/CacclGitRepoVolumeContainer.ts
var CacclGitRepoVolumeContainer = class extends import_constructs11.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    ...
    const repoUrlSecret =
      import_aws_cdk_lib13.aws_ecs.Secret.fromSecretsManager(
        import_aws_cdk_lib13.aws_secretsmanager.Secret.fromSecretCompleteArn(
          this,
          'RepoUrlSecret',
          repoUrlSecretArn,
        ),
      );
    this.container = new import_aws_cdk_lib13.aws_ecs.ContainerDefinition(
      this,
      'GitRepoVolumeContainer',
      {
        image:
          import_aws_cdk_lib13.aws_ecs.ContainerImage.fromRegistry(
            'alpine/git',
          ),
    ...
    appContainer.addContainerDependencies({
      ...
      condition:
        import_aws_cdk_lib13.aws_ecs.ContainerDependencyCondition.SUCCESS,
    });
  }
};
...
// cdk/lib/classes/CacclTaskDef.ts
var CacclTaskDef = class extends import_constructs12.Construct {
  constructor(scope, id, props) {
    super(scope, id);
    const {
      appImage,
    ...
    this.taskDef = new import_aws_cdk_lib14.aws_ecs.FargateTaskDefinition(
      this,
      'Task',
      {
        cpu: taskCpu,
    ...
    this.appOnlyTaskDef =
      new import_aws_cdk_lib14.aws_ecs.FargateTaskDefinition(
        this,
        'AppOnlyTask',
        {
          cpu: taskCpu,
    ...
    const appContainerParams = {
      ...
      logging: import_aws_cdk_lib14.aws_ecs.LogDriver.awsLogs({
        streamPrefix: 'app',
        logGroup: new import_aws_cdk_lib14.aws_logs.LogGroup(
          this,
          'AppLogGroup',
          {
            logGroupName: `/${
            ...
            removalPolicy: import_aws_cdk_lib14.RemovalPolicy.DESTROY,
            retention: logRetentionDays,
          },
        ),
      }),
    };
    this.appContainer = new import_aws_cdk_lib14.aws_ecs.ContainerDefinition(
      this,
      'AppContainer',
      appContainerParams,
    );
    ...
    new import_aws_cdk_lib14.aws_ecs.ContainerDefinition(
      this,
      'AppOnlyContainer',
    ...
    this.proxyContainer = new import_aws_cdk_lib14.aws_ecs.ContainerDefinition(
      this,
      'ProxyContainer',
      {
    ...
    new import_aws_cdk_lib14.CfnOutput(this, 'TaskDefinitionArn', {
      exportName: `${
        import_aws_cdk_lib14.Stack.of(this).stackName
      }-task-def-name`,
    ...
    new import_aws_cdk_lib14.CfnOutput(this, 'AppOnlyTaskDefinitionArn', {
      exportName: `${
        import_aws_cdk_lib14.Stack.of(this).stackName
...
if ((0, import_yn.default)(deployConfig.docDb)) {
  stackProps.dbOptions = {
    engine: CacclDbEngine_default.DocDB,
